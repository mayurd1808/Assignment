...
Secure Notes is a deployable full-stack website with real user authentication, a backend API, and SQLite database storage.
...
3. Render will use `npm start`, generate `SESSION_SECRET`, and use SQLite at `./data/app.sqlite` on the free plan.
